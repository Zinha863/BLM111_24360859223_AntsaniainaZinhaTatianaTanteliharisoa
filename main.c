// Hazırlayan: Antsaniaina Zinha Tatiana Tanteliharisoa
// 24360859223
...
// Parametre: g -> gezegenlerin yer çekimi ivmeleri
...
void asansor(float* g){
    ...
    //seçilen duruma göre uygun formülü seçilecek
    ...
    for (int i=0; i<GEZEGEN_SAYISI;i++){
        if (durum==1 || durum==2)
            ...
            printf("\t\t\nGecersiz secim!\n");
            return; //geçersiz seçim olduğunda döngü tekrarlanacak
        }
